...
pub(super) fn english(source: &str) -> Option<&'static str> {
    Some(match source {
        ...
        "不加载完整文件" => "Do not load full files",
        "不受信任" => "Untrusted",
        "不可用" => "Unavailable",
        ...
        "禁用文字差异" => "Disable word diff",
        "禁用自动换行" => "Disable line wrapping",
        "私有" => "Private",
